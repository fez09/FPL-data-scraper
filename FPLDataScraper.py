...
class fantasypl():
    ...
    def __init__(self, parent):
        ...
        parent.title('FPL Data Fetcher - v1.0 by Fez')
        ...
        Submit_button = ttk.Button(self.Frame, text="Submit", command=self.button_press).grid(row=4, padx=5, pady=5)
        ...
        parent.bind('<Return>',self.button_press)
    ...
    ## Loading Label
    def popup(self):
        ttk.Label(self.Frame, text="Please Be Patient...").grid(row=2, padx=5, pady=5)
        ttk.Label(self.Frame, text="App Might Not Respond").grid(row=5, padx=5, pady=5)
    ...
    def submit(self):
        ...
        sheet0['B10'].value = 'Your data is in the next sheet. Change sheets below or hold "CTRL+PgDown"'
        ...
        ## Creating Chart
        c1 = LineChart()
        c1.title = 'Gameweek Points / Average Points / Points Benched'
        data1 = Reference(sheet1, min_col=4, max_col=7, min_row=1, max_row=39)
        c1.height = 20
        c1.width = 50
        c1.add_data(data1, titles_from_data=True)
        sheet1.add_chart(c1, "Q2")
        ...
        self.clear()
        ttk.Label(self.Frame, text="\'{}\' Import Successful".format(json_teamname)).grid(row=2, padx=5, pady=5)
        ttk.Label(self.Frame, text="Check Directory for Excel WB").grid(row=5, padx=5, pady=5)
